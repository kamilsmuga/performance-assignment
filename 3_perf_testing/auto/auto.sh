...
TEST_PLANS=/home/comp40010/performance-assignment/3_perf_testing/auto/test
...
function attach_visualvm () {
	echo "Attaching visualvm to jboss with pid ${JBOSS_PID}"
